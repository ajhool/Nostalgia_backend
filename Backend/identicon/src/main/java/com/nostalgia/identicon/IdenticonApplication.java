...
//	public IdenticonScrubberService startQRScrubberSvc(QRServerConfig config, Environment environment) {
//		IdenticonScrubberService manager = new IdenticonScrubberService(config.getScrubberConf(), config.getQrConf().qrDirRoot);
