...
public class UserRepository {
	...
	private final UserCouchConfig config;
	...
	public UserRepository(UserCouchConfig userCouchConfig) {
	...
	public List<User> findByName(String name) throws Exception {
		ViewQuery query = ViewQuery.from("user", "by_name").inclusiveEnd(true).key(name);//.stale(Stale.FALSE);
