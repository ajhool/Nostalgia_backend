...
public class LocationRepository {
	...
	// the DB we are using
		...
		private final LocationCouchConfig config;
		...
		public LocationRepository(LocationCouchConfig locationCouchConfig) {
			config = locationCouchConfig;
			cluster = CouchbaseCluster.create(locationCouchConfig.host);
			bucket = cluster.openBucket(locationCouchConfig.bucketName, locationCouchConfig.bucketPassword);
